...
Namespace WS_GUA_Contrato
    ...
    Partial Public Class WSContrato
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.IControlIT.My.MySettings.Default.Ativvus_WS_GUA_Contrato_WSContrato
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Contrato", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        ...
        '''<remarks/>
        Public Overloads Sub ContratoAsync( _
                    ByVal pPConn_Banco As String,  _
                    ByVal pId_Contrato As Integer,  _
                    ByVal pNr_Contrato As String,  _
                    ByVal pDescricao As String,  _
                    ByVal pId_Contrato_Status As Integer,  _
                    ByVal pId_Servico As Integer,  _
                    ByVal pDt_Inicio_Vigencia As Date,  _
                    ByVal pDt_Fim_Vigencia As Date,  _
                    ByVal pId_Filial As String,  _
                    ByVal pId_Empresa_Contratada As String,  _
                    ByVal pObjeto As String,  _
                    ByVal pId_Contrato_Indice As Integer,  _
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Contrato_SLA_Servico", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        ...
        Public Overloads Sub Contrato_SLA_ServicoAsync(ByVal pPConn_Banco As String, ByVal pId_Contrato_SLA_Servico As Integer, ByVal pId_Contrato As Integer, ByVal pDescricao As String, ByVal pId_Operadora As Integer, ByVal pTipo_Servico As String, ByVal pVr_SLA_Servico As Double, ByVal pId_Contrato_Indice As Integer, ByVal pId_Usuario_Permissao As Integer, ByVal pPakage As String, ByVal pRetorno As Boolean, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("Contrato_SLA_Servico", New Object() {pPConn_Banco, pId_Contrato_SLA_Servico, pId_Contrato, pDescricao, pId_Operadora, pTipo_Servico, pVr_SLA_Servico, pId_Contrato_Indice, pId_Usuario_Permissao, pPakage, pRetorno}, Me.Contrato_SLA_ServicoOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Contrato_Filtro", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
