...
Public Class Consulta_Conta
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            divDataLote.Visible = True ' Lote visível por padrão
            divDataEmissao.Visible = False ' Emissão ocultada por padrão
            divDataVencimento.Visible = False ' Vencimento ocultada por padrão
            ...
            Dim vDataSetEmissao As New Data.DataSet
            Dim vDataSetVencimento As New Data.DataSet
            ...
            vDataSetEmissao = WS_Consulta.Lote(Session("Conn_Banco"), "sp_Data_Emissao", Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)
            vDataSetVencimento = WS_Consulta.Lote(Session("Conn_Banco"), "sp_Data_Vencimento", Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)

            oConfig.CarregaCombo(cboDataLote, vDataSet)
            oConfig.CarregaCombo(cboDataEmissao, vDataSetEmissao)
            oConfig.CarregaCombo(cboDataVencimento, vDataSetVencimento)
    ...
    Protected Sub btExecutar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btExecutar.Click
        ...
        Dim v_idusuario = Session("Id_Usuario")
        ...
        If ddlOpcoes.SelectedValue = "Lote" Then
            ...
            Session("DataSet") = WS_Rateio.Plano_Conta(Session("Conn_Banco"),
                                                            ...
                                                            True)
        End If
        If ddlOpcoes.SelectedValue = "Emissao" Then
            If Trim(cboDataEmissao.Text) = "" Then Exit Sub
            Session("DataSet") = WS_Rateio.Plano_Conta(Session("Conn_Banco"),
                                                            Nothing,
                                                            Nothing,
                                                            Nothing,
                                                            ...
                                                            Nothing,
                                                            Nothing,
                                                            cboDataEmissao.SelectedValue,
                                                            v_idusuario,
                                                            cboServico.SelectedValue,
                                                            "sp_Confere_Plano_Conta_V3_Emissao",
                                                            True)
        End If
        If ddlOpcoes.SelectedValue = "Vencimento" Then
            If Trim(cboDataVencimento.Text) = "" Then Exit Sub
            Session("DataSet") = WS_Rateio.Plano_Conta(Session("Conn_Banco"),
                                                            Nothing,
                                                            Nothing,
                                                            Nothing,
                                                            ...
                                                            Nothing,
                                                            Nothing,
                                                            cboDataVencimento.SelectedValue,
                                                            v_idusuario,
                                                            cboServico.SelectedValue,
                                                            "sp_Confere_Plano_Conta_V3_Vencimento",
                                                            True)
        End If
    ...
    Protected Sub RegistraCorAcessoBoleto(ByVal idusuario As String, ByVal documentoid As String)
        Try
            ...
            vDataSet = WS_Rateio.Plano_Conta(Session("Conn_Banco"),
                                                            ...
                                                            idusuario,
                                                            Nothing,
                                                            "sp_Insert_user_PDF_Plano_Conta",
                                                            False)

        Catch ex As Exception
            ' Captura exceções e lida com possíveis erros
            ' Exemplo: Registrar erro, mostrar mensagem ao usuário, etc.
        End Try
    End Sub

    Protected Sub RegistraCorAcessoFatura(ByVal idusuario As String, ByVal documentoid As String)
        Try
            Dim vDataSet As New System.Data.DataSet
            vDataSet = WS_Rateio.Plano_Conta(Session("Conn_Banco"),
                                                            Nothing,
    ...
    Protected Sub btFatura_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs)
        ...
        '------ registrar o acesso
        Dim v_idusuario = Session("Id_Usuario")
        Dim v_iddocumento = v_bt.CommandArgument

        RegistraCorAcessoFatura(v_idusuario, v_iddocumento)
    ...
    Protected Sub btBoleto_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs)
        ...
        RegistraCorAcessoBoleto(v_idusuario, v_iddocumento)
    ...
    Protected Sub RegistraCorAcessoNF(ByVal idusuario As String, ByVal documentoid As String)
        Try
            Dim vDataSet As New System.Data.DataSet
            vDataSet = WS_Rateio.Plano_Conta(Session("Conn_Banco"),
                                                            Nothing,
    ...
    Protected Sub btNf_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs)
        ...
        RegistraCorAcessoNF(v_idusuario, v_iddocumento)
    ...
    Protected Sub RegistraCorAcessoRateio(ByVal idusuario As String, ByVal documentoid As String)
        Try
            Dim vDataSet As New System.Data.DataSet
            vDataSet = WS_Rateio.Plano_Conta(Session("Conn_Banco"),
                                                            Nothing,
    ...
    Protected Sub btRateio_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        RegistraCorAcessoRateio(v_idusuario, v_iddocumento)
    ...
    Protected Sub BtDwZip_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btDwZip.Click
        ...
        If Not String.IsNullOrEmpty(Trim(txtPesquisa.Text)) Then
            dt.Tables(0).DefaultView.RowFilter = $"[Operadora] LIKE '%{txtPesquisa.Text}%' OR 
                                               [Fatura] LIKE '%{txtPesquisa.Text}%' OR
                                               [Pedido] LIKE '%{txtPesquisa.Text}%' OR
                                               [Req] LIKE '%{txtPesquisa.Text}%'"
        Else
            ' Reseta o filtro, exibindo todas as linhas
            dt.Tables(0).DefaultView.RowFilter = String.Empty
        End If
        ...
        Dim filteredRows As DataView = dt.Tables(0).DefaultView
        'For Each table As DataTable In dt.Tables
        '    For Each row As DataRow In table.Rows
        For Each rowView As DataRowView In filteredRows
            Dim row As DataRow = rowView.Row
            If (row("Download_Fatura") = "GREEN" Or row("Download_Fatura") = "YELLOW") Then
                RetornaIdFatura(row("Fatura"), dataatual)
                v_iddocumento = row("Fatura")
    ...
    '----- K2AIcontrolIt - 262
    'Protected Sub RblOpcoes_SelectedIndexChanged(sender As Object, e As EventArgs) Handles rblOpcoes.SelectedIndexChanged
    '    Select Case rblOpcoes.SelectedValue
    '        Case "Lote"
    '            divDataLote.Visible = True
    '            divDataEmissao.Visible = False
    '            divDataVencimento.Visible = False
    '        Case "Emissao"
    '            divDataLote.Visible = False
    '            divDataEmissao.Visible = True
    '            divDataVencimento.Visible = False
    '        Case "Vencimento"
    '            divDataLote.Visible = False
    '            divDataEmissao.Visible = False
    '            divDataVencimento.Visible = True
    '    End Select
    'End Sub

    Protected Sub ddlOpcoes_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlOpcoes.SelectedIndexChanged
        Select Case ddlOpcoes.SelectedValue
            Case "Lote"
                divDataLote.Visible = True
                divDataEmissao.Visible = False
                divDataVencimento.Visible = False
