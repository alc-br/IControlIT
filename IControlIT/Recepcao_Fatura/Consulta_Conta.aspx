        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-5">
                            <asp:Label ID="lblServico" runat="server" CssClass="configlabel" Text="Servi�o:" Style="float: left" Font-Names="Segoe UI Semibold" Font-Size="12pt"></asp:Label>
                    ...
                    <div class="row">
                        ...
                        <%--<div class="col-md-6 mb-5">
                            <div style="width: 100%; height: 100%; position: relative;">
                                ...
                                <%--<asp:Label ID="blBtDwZip" runat="server" CssClass="configlabel" Visible="false" Text="Arquivos dispon�veis em [ C:\tempIControlIt ]" Style="left: 9px; top: 13px; float: left;" ForeColor="#C1C1C1"></asp:Label>--%>
                            <%--</div>--%>
                        </div>	
                    </div>
                    <div class="row">
                        <div class="col-md-12 overflow-auto">
                            <asp:DataGrid ID="dtgConsultaConta" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="5" CellSpacing="5"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn SortExpression="Dt_Emissao" DataField="Dt_Emissao" HeaderText="Dt. Emiss�o" Visible="True" DataFormatString="{0:dd/MM/yyyy}">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                                    </asp:BoundColumn>
                                    ...
                                    <%--<asp:BoundColumn SortExpression="Observa��o" DataField="Observacao" HeaderText="Observa��o" Visible="True">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" />
                                    </asp:BoundColumn>--%>
                                    <asp:TemplateColumn HeaderText="Observa��o">
                                        <ItemTemplate>
                                    ...
                                    <%--<asp:BoundColumn SortExpression="Provis�o" DataField="Provisao" HeaderText="Provis�o" Visible="True">--%>
                                    <asp:TemplateColumn HeaderText="Provis�o">
                                        <%--<ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" />--%>
                                         <ItemTemplate>
                                             <div  style="display: flex;justify-content: center;align-items: center;">
                                                <asp:Image ID="imgProvisao" runat="server"  style="width: 30px;"
                                                    ...
                                                    AlternateText='<%# IIf(Convert.ToInt32(Eval("Provisao")) = 1, "Com previs�o", "Sem previs�o") %>' />
                                              </div>
                                        </ItemTemplate>
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" />
                                    <%--</asp:BoundColumn>--%>
        ...
        <div class="modalPopup">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:Label ID="Label2" runat="server" CssClass="configlabel" Text="Todas faturas est�o dispon�veis e preparadas para baixar!" Style="float: left" Font-Names="Segoe UI Semibold" Font-Size="18pt"></asp:Label>
