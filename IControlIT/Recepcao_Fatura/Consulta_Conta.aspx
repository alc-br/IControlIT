        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <asp:Label ID="Label5" runat="server" CssClass="configlabel" Text="Selecione o filtro:" Style="float: left" Font-Names="Segoe UI Semibold" Font-Size="12pt"></asp:Label>
                            <asp:DropDownList ID="ddlOpcoes" runat="server" AutoPostBack="True" Width="100%" TabIndex="2" CssClass="configCombo" OnSelectedIndexChanged="ddlOpcoes_SelectedIndexChanged">
                                <asp:ListItem Text="Lote" Value="Lote" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="Emissão" Value="Emissao"></asp:ListItem>
                                <asp:ListItem Text="Vencimento" Value="Vencimento"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div id="divDataLote" class="col-md-3" runat="server" visible="true">
                        ...
                        <div id="divDataEmissao" class="col-md-3" runat="server" visible="false">
                            <asp:Label ID="Label3" runat="server" CssClass="configlabel" Text="Data (Emissão):" Style="float: left" Font-Names="Segoe UI Semibold" Font-Size="12pt"></asp:Label>
                            <asp:DropDownList ID="cboDataEmissao" runat="server" Width="100%" TabIndex="2" CssClass="configCombo"></asp:DropDownList>
                        </div>
                        <div id="divDataVencimento" class="col-md-3" runat="server" visible="false">
                            <asp:Label ID="Label4" runat="server" CssClass="configlabel" Text="Data (Vencimento):" Style="float: left" Font-Names="Segoe UI Semibold" Font-Size="12pt"></asp:Label>
                            <asp:DropDownList ID="cboDataVencimento" runat="server" Width="100%" TabIndex="2" CssClass="configCombo"></asp:DropDownList>
                        </div>
                        <div class="col-md-2">
