...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="pnlObservacao" runat="server" class="bgModal" visible="false">
        <div class="modalPopup">
            <div class="row">
                <div class="col-md-12">
                    <asp:Label ID="lblDLinhaConta" runat="server" CssClass="configlabel" Text="Observa��o" Style="float: left" Font-Names="Segoe UI Semibold" Font-Size="18pt"></asp:Label>
    ...
    <div id="pnlRegistro" runat="server" class="bgModal" visible="false">
        <div class="modalPopup">
            ...
            <div class="row">
                <div class="col-md-12">
                    <asp:Label ID="lblObservacao" runat="server" CssClass="configlabel" Text="Observa��o" Style="float: left" Font-Names="Segoe UI" Font-Size="12pt"></asp:Label>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="lblEmailCopia" runat="server" CssClass="configlabel" Text="e-mail C�pia"></asp:Label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="lblMatricula_Chefia" runat="server" CssClass="configlabel" Text="Matr�cula chefia"></asp:Label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="lblSecao" runat="server" CssClass="configlabel" Text="Se��o"></asp:Label>
                            <asp:DropDownList ID="cboSecao" runat="server" CssClass="configCombo" EnableTheming="True" TabIndex="14" Width="100%"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <asp:Label ID="lblStatus" runat="server" CssClass="configlabel" Text="Situa��o cadastral"></asp:Label>
            ...
            fetch(checkUrl, { method: "GET" })
                .then(response => {
                    if (response.status === 204) {
                        // CORREÇÃO: Oculta o elemento PAI (a div) que contém os dois ícones.
                ...
                .catch(error => {
                    ...
                    // Oculta o elemento PAI também em caso de erro.
                    if (link.parentElement) {
                        link.parentElement.style.display = "none";
                    }
                });
...
<%-- [FIM - ICTRL-NF-202506-026] --%>
    <%-- [INÍCIO - ICTRL-NF-202506-026] --%>
    <script>
        // Função para enviar um único termo
        ...
        // Função para enviar todos os termos
        function enviarTodosTermos() {
            const termos = document.querySelectorAll(".termo-download");
            if (termos.length === 0) {
                alert("Nenhum ativo com termo disponível para envio.");
                return;
            }
            ...
            alert(termos.length + " solicitação(ões) de aceite enviada(s).");
        }
    </script>
    <%-- [FIM - ICTRL-NF-202506-026] --%>
