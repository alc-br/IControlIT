Public Class Ativo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        WS_Cadastro.Envia_Log(Session("Conn_Banco"),
                                                      Session("Id_Usuario"),
                                                      DateTime.Now,
                                                        $"Tela Ativo - Visualiza��o {Request("ID")}",
                                                        False)
    ...
    Protected Sub btOk_Click(sender As Object, e As EventArgs) Handles btOk.Click
        ...
        txtIdentificacao.Text = WS_Cadastro.Ativo(Session("Conn_Banco"),
                                                        ...
                                                        oConfig.ValidaCampo(Mid(txtObservacao.Text, 1, 8000) + " | Usu�rio - " + Session("Nm_Usuario")),
        ...
        If txtIdentificacao.Text = -1 Then
            Call Master.Registro_Salvo("Verifique se o login do usu�rio est� cadastrado para funcionar as datas de desativa��o e ativa��o.")
    ...
    Protected Sub btDesativar_Click(sender As Object, e As EventArgs)
        ...
        WS_Cadastro.Ativo(Session("Conn_Banco"), txtIdentificacao.Text,
                                ...
                                Nothing, " | Usu�rio - " + Session("Nm_Usuario"), Nothing, Nothing,
