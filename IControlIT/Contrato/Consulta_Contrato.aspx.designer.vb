...
Partial Public Class Consulta_Contrato
    ...
    ' [INÍCIO - ICTRL-NF-202509-002] - Filtros
    '''<summary>
    ...
    '''<summary>
    '''Controle lblDataInicioVigencia.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declara��o de campo do arquivo de designer a um arquivo code-behind.
