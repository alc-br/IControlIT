...
<%-- [INÍCIO - ICTRL-NF-202509-002] - Filtros acima da tabela Contrato_Tabela1 --%>
                ...
                <div class="col-md-12">
                    <div id="DivCustoFixo" runat="server" style="overflow: auto; width: 100%;">
                        <asp:DataGrid ID="dtgLista" runat="server" AutoGenerateColumns="False" BorderColor="Black" CellPadding="5" CellSpacing="5" Font-Bold="False" HorizontalAlign="Center" Font-Italic="False" BackColor="Transparent" Font-Names="Arial"
                            ...
                            <Columns>
                                <asp:BoundColumn DataField="Descricao" HeaderText="Descri��o"></asp:BoundColumn>
        ...
        <div class="col-md-12">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <asp:Button ID="btnProduto" runat="server" class="btn-tab-disable pull-left" Text="Servi�o" CausesValidation="False" OnClick="btnProduto_Click" />
                                                ...
                                                <table style="width: 100%;">
                                                            ...
                                                            <table style="width: 100%;">
                                                                <tr>
                                                                    <td style="width: 100px;">
                                                                        <asp:Label ID="lblContrato" runat="server" CssClass="configlabel" Text="N�mero.:" ForeColor="#9CCC2A"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: Left; height: 40px">
                                                            <asp:Label ID="lblInformacao" runat="server" Text="Informa��o" Font-Bold="False" Font-Names="Verdana" Font-Size="12pt" ForeColor="#666666"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                ...
                                <div class="col-md-12">
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblProduto" runat="server" Font-Bold="False" Font-Names="Microsoft JhengHei Light" Font-Size="Larger" ForeColor="#333333" Text="Produtos e Servi�os Contratados" Style="float: none"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="col-md-12 overflow-auto">
                                    <asp:DataGrid ID="dtgProduto" runat="server" AutoGenerateColumns="True" BorderColor="Black" CellPadding="5" Font-Bold="False" HorizontalAlign="Center" Font-Italic="False" BackColor="Transparent" Font-Names="Arial"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="Descri��o">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateColumn HeaderText="A��o" ItemStyle-Width="60px">
                                                <ItemTemplate>
                                ...
                                <div class="col-md-12">
                                    <asp:DataGrid ID="dtgAditivo" runat="server" AutoGenerateColumns="False" BorderColor="Black" CellPadding="5" CellSpacing="5" Font-Bold="False" HorizontalAlign="Center" Font-Italic="False" BackColor="Transparent" Font-Names="Arial"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="Dt_Vigencia" HeaderText="Vig�ncia" Visible="True">
                                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" />
                                            </asp:BoundColumn>
                                        </Columns>
