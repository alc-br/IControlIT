...
<div class="row m-2">
  <div class="col-md-12">            
      <asp:TextBox ID="txtPesquisa" runat="server" CssClass="configtext" Visible="true" AutoPostBack="true" Width="25%" placeholder="Filtro ..."></asp:TextBox>              
  </div>
</div>
        ...
        <div class="col-md-12 overflow-auto">
            <asp:DataGrid ID="dtgContrato_Tabela" runat="server" AutoGenerateColumns="False" CellPadding="5" CellSpacing="5" EnableTheming="True" Font-Bold="False" Font-Italic="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        <ItemTemplate>
                            <asp:ImageButton ID="btExibirAnexo" runat="server" ImageUrl="~/Img_Sistema/Botao/Grid/Grid_View.png" OnClick="btExibirAnexo_Click" Height="25px" CausesValidation="False" />
                        </ItemTemplate>
                    </asp:TemplateColumn>

                    <asp:BoundColumn SortExpression="Nr_Contrato" DataField="Nr_Contrato" HeaderText="Numero do Contrato" Visible="True">
                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" />
                    </asp:BoundColumn>
